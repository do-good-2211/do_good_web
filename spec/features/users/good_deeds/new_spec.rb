...
RSpec.describe "User good deed new page" do
  describe "As a logged in user" do
    ...
    it "When I visit '/user/good_deeds/new' I see the name of the good deed, a from with fields for date, time and checkboxes for other users and a button 'Do Good'" do
