...
RSpec.describe "/dashboard", type: :feature do
  describe "As a logged in user, when I visit the users's show page" do
    describe "when successful" do
      ...
      let(:deed1) do
        { id: "55", type: "good_deed",
          attributes: { host_name: "Sally Seashells", host_id: 2, name: "Deed1 High-five a stranger", date: "2024-09-10", time: "2000-01-01T13:00:00.000Z", status: "In Progress", media_link: nil, notes: nil, attendees: [{ name: "Tink" }, { name: "Hook" }] } }
      end
      let(:deed2) do
        { id: "44", type: "good_deed",
          attributes: { host_name: "Sally Seashells", host_id: 2, name: "Deed2 Donate Blood.", date: "2024-02-02", time: "2000-01-01T16:00:00.000Z", status: "Completed", media_link: image_url, notes: "fun", attendees: [{ name: "Sneezy" }, { name: "Grumpy" }] } }
      end
      let(:deed3) do
        { id: "33", type: "good_deed",
          attributes: { host_name: "John Smith", host_id: 1, name: "Deed3 Pick up Trash.", date: "2024-05-30", time: "2000-01-01T14:00:00.000Z", status: "Completed", media_link: image_url, notes: "super fun", attendees: [{ name: "Dori" }, { name: "Nemo" }] } }
      end
      let(:deed4) do
      ...
      it "when I click on the Update button under You're Hosting, I'm redirected to /user/good_deeds/:id/edit" do
        deed4_object = Deed.new({ id: "22", type: "good_deed",
                                  attributes: { host_name: "John Smith", host_id: 1, name: "Deed4 Tip Generously.", date: "2024-11-11", time: "2000-01-01T22:00:00.000Z", status: "In Progress", media_link: nil, notes: nil, attendees: [{ name: "Harry" }, { name: "Ron" }] } })
      ...
      it "when I click on the Update button under Past Good Deeds that were hosted, I'm redirected to /user/good_deeds/:id/edit" do
        deed3_object = Deed.new({ id: "33", type: "good_deed",
                                  attributes: { host_name: "John Smith", host_id: 1, name: "Deed3 Pick up Trash.", date: "2024-05-30", time: "2000-01-01T14:00:00.000Z", status: "Completed", media_link: image_url, notes: "super fun", attendees: [{ name: "Dori" }, { name: "Nemo" }] } })
